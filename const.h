...
#define BLOCK64 64
#define BLOCKCOL 72               // BLOCK64+8
#define BLOCK16  16                // BLOCK64/4 
#define NUMSTREAM 47     // 23
#define MAXTHREAD 16
#define METASIZE 64
#define METAUINT 16
//#define SUB_BLOCK 8
#define SUBROW   8                       // BLOCK64 / SUB_BLOCK
#define SUBCOL   8                       // BLOCK64 / SUB_BLOCK
#define SUBCOL9   9                      // SUBCOL + 1
#define ALLOCDOUBLE 4608                 // SUBROW*SUBCOL9*64     // *SUB_BLOCK*SUB_BLOCK
#define ALLOCBLOCK   36864               // ALLOCDOUBLE*8
#define DETAILOFFSET 64                  // SUBCOL*8             // *SUB_BLOCK
#define DETAILSKIPSHORT   288             // SUBCOL9*8*4
#define METAOFFSET   352                  // DETAILSKIPSHORT+DETAILOFFSET
#define METAMASK 0xff
#define CACHE64 64
...
#define MEMBLOB 0x400000 // 0x400000 // 4M //0x2000000   // 32M
